...
if __name__ == '__main__':
    ...
    read_file2 = ['T1_R1', 'T1_R2', 'T1_R3', 'T1_R4',
    ...
    read_file3 = ['T1_R1', 'T1_R2', 'T1_R3',
                  'T2_R1', 'T2_R2', 'T2_R3',
                  'T3_R1', 'T3_R2', 'T3_R3',
                  'T4_R1', 'T4_R2', 'T4_R3',
                  'T5_R1', 'T5_R2', 'T5_R3',
                  'T21_R1', 'T21_R2', 'T21_R3',
                  'T22_R1', 'T22_R2', 'T22_R3',
                  'T23_R1', 'T23_R2', 'T23_R3',
                  'T24_R1', 'T24_R2', 'T24_R3',
                  'T25_R1', 'T25_R2', 'T25_R3',
                  'T26_R1', 'T26_R2', 'T26_R3',
                  'T27_R1', 'T27_R2', 'T27_R3']

    rssi_features = []
    gt_positions = []
    num = 0

    for trial_name in read_file3:
        num += 1
    ...
    with open('knn/knn_model_R123_fixed.pkl','wb') as f:
        pickle.dump(model,f)
