...
# 第一張圖：加速度
plt.subplot(3, 1, 1)
plt.plot(timestamps, acc_x_world, label='acc_x')
plt.plot(timestamps, acc_y_world, label='acc_y')
plt.plot(timestamps, acc_z_world, label='acc_z')
...
# 第二張圖：角速度
plt.subplot(3, 1, 2)
plt.plot(timestamps, gyro_x_world, label='gyro_x')
plt.plot(timestamps, gyro_y_world, label='gyro_y')
plt.plot(timestamps, gyro_z_world, label='gyro_z')
plt.gca().yaxis.set_major_locator(ticker.MultipleLocator(2))
plt.tick_params(axis='both', labelsize=20)
...
# 第三張圖：磁力計
plt.subplot(3, 1, 3)
plt.plot(timestamps, mag_x_world, label='mag_x')
plt.plot(timestamps, mag_y_world, label='mag_y')
plt.plot(timestamps, mag_z_world, label='mag_z')
plt.tick_params(axis='both', labelsize=20)
